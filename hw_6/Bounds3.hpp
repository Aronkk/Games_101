...
class Bounds3
{
  public:
    ...
    // 两个点，可以涵括 Xmin,Xmax,Ymin,Ymax,Zmin,Zmax;
    Bounds3()
    {
                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    // TODO test if ray bound intersects, 测试光线边界是否相交
    // 光线传播方向不同的情况下计算的最短、最长时间不一样，需要再矫正一下
